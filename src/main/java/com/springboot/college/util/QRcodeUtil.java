...
public class QRcodeUtil {
    ...
    /**
     * 创建二维码输入流 可以直接将二维码以流的形式返回给页面 创建带有logo的二维码
     * @param content
     * @param qrCodeSize
     * @param imageFormat
     * @param imgPath
     ...
     * @throws WriterException
     */
    public static void createQrCodeStreamLogo(String content, int qrCodeSize, String imageFormat,String imgPath,boolean needCompress, HttpServletResponse response) throws IOException, WriterException {
        //设置二维码纠错级别ＭＡＰ
        Hashtable<EncodeHintType, ErrorCorrectionLevel> hintMap = new Hashtable<EncodeHintType, ErrorCorrectionLevel>();
        hintMap.put(EncodeHintType.ERROR_CORRECTION, ErrorCorrectionLevel.L);  // 矫错级别
        QRCodeWriter qrCodeWriter = new QRCodeWriter();
    ...
    //另一种方法
    /**
    public static void encode(String content, String imgPath, String destPath, boolean needCompress, HttpServletResponse response) throws Exception {

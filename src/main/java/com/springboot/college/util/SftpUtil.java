...
//                this.sftp.quit();
     ...
     * 下载单个文件给前端
     *
     * @param directory 下载目录: /home/ftp_files/images/
     * @param fileName  下载的文件名称: default.jpg
     * @throws Exception
     */
    public InputStream downloadToResult(String directory, String fileName) throws Exception {
        this.sftp.cd(directory);
